                    ...
                    children: <Widget>[
                      ...
                      RaisedButton.icon(
                        ...
                        onPressed: () {
                          ...
                          Scaffold.of(context).showSnackBar(SnackBar(content: Text('Changes saved!'),));
                        },
                        label: Text('Save'),
                      ),
                    ],
              ...
              Row(
                ...
                children: <Widget>[
                  ...
                  RaisedButton.icon(
                    icon: Icon(Icons.save),
                    onPressed:(){
                      (globals.words)[widget.index].meaning = meaningcontroller.text;
                      (globals.words)[widget.index].sentence = sentencecontroller.text;
                      setState(() {
                        isEditing = false;
                      });
                      Scaffold.of(context).showSnackBar(SnackBar(content: Text('Changes saved!'),));
