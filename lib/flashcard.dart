...
class _FlashCardState extends State<FlashCard> {
  List<Words> words = [
    Words(word: 'Hello', meaning: 'Greeting', sentence: 'Hello World'),
    Words(word: 'World', meaning: 'Surroundings', sentence: 'World Wide Web'),
    Words(
      word: 'Flutter',
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: FlipCard(
        front: Card(
          child: Center(
            child: Text('${widget.currWords.word}'),
          ),
        ),
        back: Card(
          child: Center(
            child: Column(
              ...
              children: <Widget>[
                Text('${widget.currWords.meaning}'),
                Text('${widget.currWords.sentence}'),
              ],
            ),
          ),
        ),
