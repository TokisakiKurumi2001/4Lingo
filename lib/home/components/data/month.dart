...
class _MonthDataState extends State<MonthData> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<ChartData> dulieudothi1 = [
      ChartData(
          numvocabs: dulieutrongtuan[0].numlearnedvocabs,
          barColor: dothi.ColorUtil.fromDartColor(Colors.indigo),
          specifictime: '1st'),
      ChartData(
          numvocabs: dulieutrongtuan[1].numlearnedvocabs,
          barColor: dothi.ColorUtil.fromDartColor(Colors.indigo),
          specifictime: '2nd'),
      ChartData(
          numvocabs: dulieutrongtuan[2].numlearnedvocabs,
          barColor: dothi.ColorUtil.fromDartColor(Colors.indigo),
          specifictime: '3rd'),
      ChartData(
          numvocabs: dulieutrongtuan[3].numlearnedvocabs,
          barColor: dothi.ColorUtil.fromDartColor(Colors.indigo),
          specifictime: '4th'),
    ];
    final List<ChartData> dulieudothi2 = [
      ChartData(
          numvocabs: dulieutrongtuan[0].totalvocabs,
          barColor: dothi.ColorUtil.fromDartColor(Colors.green[300]),
          specifictime: '1st'),
      ChartData(
          numvocabs: dulieutrongtuan[1].totalvocabs,
          barColor: dothi.ColorUtil.fromDartColor(Colors.green[300]),
          specifictime: '2nd'),
      ChartData(
          numvocabs: dulieutrongtuan[2].totalvocabs,
          barColor: dothi.ColorUtil.fromDartColor(Colors.green[300]),
          specifictime: '3rd'),
      ChartData(
          numvocabs: dulieutrongtuan[3].totalvocabs,
          barColor: dothi.ColorUtil.fromDartColor(Colors.green[300]),
          specifictime: '4th'),
    ];
    return SafeArea(
                      ...
                      Column(
                        children: <Widget>[
                          Container(
                            ...
                            child: Text(
                              'Number of vocabs you with to learn',
                              style: TextStyle(
