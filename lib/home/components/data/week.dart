...
class _WeekDataState extends State<WeekData> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<ChartData> dulieudothi1 = [
      ChartData(
          specifictime: 'Mo',
          numvocabs: array[0].vocabs,
          barColor: dothi.ColorUtil.fromDartColor(Colors.red[400])),
      ChartData(
          specifictime: 'Tu',
          numvocabs: array[1].vocabs,
          barColor: dothi.ColorUtil.fromDartColor(Colors.red[400])),
      ChartData(
          specifictime: 'We',
          numvocabs: array[2].vocabs,
          barColor: dothi.ColorUtil.fromDartColor(Colors.red[400])),
      ChartData(
          specifictime: 'Th',
          numvocabs: array[3].vocabs,
          barColor: dothi.ColorUtil.fromDartColor(Colors.red[400])),
      ChartData(
          specifictime: 'Fr',
          numvocabs: array[4].vocabs,
          barColor: dothi.ColorUtil.fromDartColor(Colors.red[400])),
      ChartData(
          specifictime: 'Sa',
          numvocabs: array[5].vocabs,
          barColor: dothi.ColorUtil.fromDartColor(Colors.red[400])),
      ChartData(
          specifictime: 'Su',
          numvocabs: array[6].vocabs,
          barColor: dothi.ColorUtil.fromDartColor(Colors.red[400])),
    ];
    final List<ChartData> dulieudothi2 = [
      ChartData(
          specifictime: 'Mo',
          numvocabs: array[0].learned,
          barColor: dothi.ColorUtil.fromDartColor(Colors.blue[400])),
      ChartData(
          specifictime: 'Tu',
          numvocabs: array[1].learned,
          barColor: dothi.ColorUtil.fromDartColor(Colors.blue[400])),
      ChartData(
          specifictime: 'We',
          numvocabs: array[2].learned,
          barColor: dothi.ColorUtil.fromDartColor(Colors.blue[400])),
      ChartData(
          specifictime: 'Th',
          numvocabs: array[3].learned,
          barColor: dothi.ColorUtil.fromDartColor(Colors.blue[400])),
      ChartData(
          specifictime: 'Fr',
          numvocabs: array[4].learned,
          barColor: dothi.ColorUtil.fromDartColor(Colors.blue[400])),
      ChartData(
          specifictime: 'Sa',
          numvocabs: array[5].learned,
          barColor: dothi.ColorUtil.fromDartColor(Colors.blue[400])),
      ChartData(
          specifictime: 'Su',
          numvocabs: array[6].learned,
          barColor: dothi.ColorUtil.fromDartColor(Colors.blue[400])),
    ];
            ...
            Padding(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: [
                    BoxShadow(
                        color: Colors.red, blurRadius: 12, offset: Offset(0, 5))
                  ],
