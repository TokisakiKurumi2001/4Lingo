...
class _YearDataState extends State<YearData> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<ChartData> dulieudothi1 = [
      ChartData(
          numvocabs: dulieu[0].monthtotallearned,
          barColor: dothi.ColorUtil.fromDartColor(Colors.pinkAccent),
          specifictime: 'Jan'),
      ChartData(
          numvocabs: dulieu[1].monthtotallearned,
          barColor: dothi.ColorUtil.fromDartColor(Colors.pinkAccent),
          specifictime: 'Feb'),
      ChartData(
          numvocabs: dulieu[2].monthtotallearned,
          barColor: dothi.ColorUtil.fromDartColor(Colors.pinkAccent),
          specifictime: 'Mar'),
      ChartData(
          numvocabs: dulieu[3].monthtotallearned,
          barColor: dothi.ColorUtil.fromDartColor(Colors.pinkAccent),
          specifictime: 'Apr'),
      ChartData(
          numvocabs: dulieu[4].monthtotallearned,
          barColor: dothi.ColorUtil.fromDartColor(Colors.pinkAccent),
          specifictime: 'May'),
      ChartData(
          numvocabs: dulieu[5].monthtotallearned,
          barColor: dothi.ColorUtil.fromDartColor(Colors.pinkAccent),
          specifictime: 'Jun'),
      ChartData(
          numvocabs: dulieu[6].monthtotallearned,
          barColor: dothi.ColorUtil.fromDartColor(Colors.pinkAccent),
          specifictime: 'Jul'),
      ChartData(
          numvocabs: dulieu[7].monthtotallearned,
          barColor: dothi.ColorUtil.fromDartColor(Colors.pinkAccent),
          specifictime: 'Aug'),
      ChartData(
          numvocabs: dulieu[8].monthtotallearned,
          barColor: dothi.ColorUtil.fromDartColor(Colors.pinkAccent),
          specifictime: 'Sep'),
      ChartData(
          numvocabs: dulieu[9].monthtotallearned,
          barColor: dothi.ColorUtil.fromDartColor(Colors.pinkAccent),
          specifictime: 'Oct'),
      ChartData(
          numvocabs: dulieu[10].monthtotallearned,
          barColor: dothi.ColorUtil.fromDartColor(Colors.pinkAccent),
          specifictime: 'Nov'),
      ChartData(
          numvocabs: dulieu[11].monthtotallearned,
          barColor: dothi.ColorUtil.fromDartColor(Colors.pinkAccent),
          specifictime: 'Dec'),
    ];
    final List<ChartData> dulieudothi2 = [
      ChartData(
          numvocabs: dulieu[0].monthtotalvocab,
          barColor: dothi.ColorUtil.fromDartColor(Colors.amber),
          specifictime: 'Jan'),
      ChartData(
          numvocabs: dulieu[1].monthtotalvocab,
          barColor: dothi.ColorUtil.fromDartColor(Colors.amber),
          specifictime: 'Feb'),
      ChartData(
          numvocabs: dulieu[2].monthtotalvocab,
          barColor: dothi.ColorUtil.fromDartColor(Colors.amber),
          specifictime: 'Mar'),
      ChartData(
          numvocabs: dulieu[3].monthtotalvocab,
          barColor: dothi.ColorUtil.fromDartColor(Colors.amber),
          specifictime: 'Apr'),
      ChartData(
          numvocabs: dulieu[4].monthtotalvocab,
          barColor: dothi.ColorUtil.fromDartColor(Colors.amber),
          specifictime: 'May'),
      ChartData(
          numvocabs: dulieu[5].monthtotalvocab,
          barColor: dothi.ColorUtil.fromDartColor(Colors.amber),
          specifictime: 'Jun'),
      ChartData(
          numvocabs: dulieu[6].monthtotalvocab,
          barColor: dothi.ColorUtil.fromDartColor(Colors.amber),
          specifictime: 'Jul'),
      ChartData(
          numvocabs: dulieu[7].monthtotalvocab,
          barColor: dothi.ColorUtil.fromDartColor(Colors.amber),
          specifictime: 'Aug'),
      ChartData(
          numvocabs: dulieu[8].monthtotalvocab,
          barColor: dothi.ColorUtil.fromDartColor(Colors.amber),
          specifictime: 'Sep'),
      ChartData(
          numvocabs: dulieu[9].monthtotalvocab,
          barColor: dothi.ColorUtil.fromDartColor(Colors.amber),
          specifictime: 'Oct'),
      ChartData(
          numvocabs: dulieu[10].monthtotalvocab,
          barColor: dothi.ColorUtil.fromDartColor(Colors.amber),
          specifictime: 'Nov'),
      ChartData(
          numvocabs: dulieu[11].monthtotalvocab,
          barColor: dothi.ColorUtil.fromDartColor(Colors.amber),
          specifictime: 'Dec'),
    ];
    return SafeArea(
